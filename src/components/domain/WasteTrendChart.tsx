    ...
    <Card className="h-full transition-colors">
      <CardContent className="p-5">
        <div className="flex justify-between items-center mb-4">
          <h3 className="text-base font-bold text-foreground">일별 폐기 추이 (kg)</h3>
        ...
        <div className="flex items-center justify-center gap-6 mt-4 text-xs">
          <div className="flex items-center gap-2">
            ...
            <span className="text-muted-foreground">평균 기준선</span>
          </div>
          <div className="flex items-center gap-2">
            <span className="w-3 h-3 rounded-full border-2 border-primary"></span>
            <span className="text-muted-foreground">실제 폐기량</span>
          </div>
        </div>
      </CardContent>
    </Card>
