...
export const DEFAULT_DATA_SOURCE_CONFIG: DataSourceConfig = {
  ...
  sheets: [
    ...
    },
    {
      ...
      enabled: true,
      columns: [
        { key: 'productCode', column: 'A', label: '품목코드', type: 'string' },
        { key: 'productName', column: 'B', label: '품목명', type: 'string' },
        { key: 'date', column: 'C', label: '일별', type: 'date' },
        { key: 'customer', column: 'D', label: '거래처별', type: 'string' },
        { key: 'itemName', column: 'E', label: '품목별', type: 'string' },
        { key: 'spec', column: 'F', label: '규격', type: 'string' },
        { key: 'quantity', column: 'G', label: '수량', type: 'number' },
        { key: 'supplyAmount', column: 'H', label: '공급가액', type: 'number' },
        { key: 'vat', column: 'I', label: '부가세', type: 'number' },
        { key: 'total', column: 'J', label: '합계', type: 'number' },
      ],
      notes: '배송행은 마이너스 금액, 날짜형식 YYYY/MM/DD',
    },
    {
      id: 'bom_san',
      name: 'BOM (SAN)',
    ...
    },
    {
      ...
      columns: [
        ...
        { key: 'productName', column: 'B', label: '품목별', type: 'string' },
        ...
        { key: 'receivingPrice', column: 'I', label: '입고단가', type: 'number' },
        { key: 'receivingTotal', column: 'J', label: '입고금액', type: 'number' },
      ],
      notes: '숫자에 쉼표 포함, 접두사 ZIP_M_(원재료)/ZIP_H_(반재료)/ZIP_S_(부자재)',
    },
    {
      id: 'orders',
      name: '발주현황',
