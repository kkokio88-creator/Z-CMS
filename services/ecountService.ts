import {
    ChannelProfitData, InventorySafetyItem, BomDiffItem,
    ...
    try {
        ...
        if (!hasAnyData) {
            return {
                ...emptyResult,
                dataAvailable: false,
                message: 'ECOUNT에서 데이터를 찾을 수 없습니다. API 권한 또는 데이터 존재 여부를 확인하세요.'
            };
        }
        ...
        const statusMessage = unavailableTypes.length > 0
