import { AnomalyInsight, BomDiffItem, TopWasteItem, WasteTrendData, ChannelProfitData, InventorySafetyItem, StocktakeAnomalyItem, ProfitRankItem, CostStructure, InventoryHistory, StocktakeHistory, Notification, ChannelMix, TurnoverTrendData, WasteReasonData, BomHistoryItem, DashboardSummary, Supplier, OrderSuggestion } from './types.ts';
...
export const BOM_DIFF_ITEMS: BomDiffItem[] = [
  {
    ...
    anomalyScore: 92,
    costImpact: -2450.00,
    reasoning: '최근 습도 증가로 인한 원료 뭉침 현상 발생 가능성이 높습니다 (상관관계 0.82). 믹서 RPM 보정이 필요합니다.',
    status: 'pending'
  },
  {
    id: '2',
...
export const BOTTOM_PROFIT_ITEMS: ProfitRankItem[] = [
  { id: 'b1', rank: 1, skuName: 'Old-Stock-Clearance', channel: '오프라인', profit: -2500000, margin: -15 },
...
export const INVENTORY_SAFETY_DATA: InventorySafetyItem[] = [
  { id: '1', skuName: 'Motor-DC-12V', currentStock: 120, safetyStock: 150, status: 'Shortage', turnoverRate: 12.5, warehouse: 'WH-A', category: '전자부품' },
  { id: '2', skuName: 'Housing-Plastic-ABS', currentStock: 2500, safetyStock: 800, status: 'Overstock', turnoverRate: 2.1, warehouse: 'WH-B', category: '기구물' },
  { id: '3', skuName: 'PCB-Main-V3', currentStock: 450, safetyStock: 400, status: 'Normal', turnoverRate: 8.4, warehouse: 'WH-A', category: '전자부품' },
  { id: '4', skuName: 'Screw-M3-10mm', currentStock: 100, safetyStock: 1000, status: 'Shortage', turnoverRate: 15.2, warehouse: 'WH-C', category: '부자재' },
  { id: '5', skuName: 'Pkg-Box-S', currentStock: 5000, safetyStock: 2000, status: 'Overstock', turnoverRate: 1.5, warehouse: 'WH-B', category: '포장재' },
  { id: '6', skuName: 'LED-Array-W', currentStock: 800, safetyStock: 800, status: 'Normal', turnoverRate: 9.0, warehouse: 'WH-A', category: '전자부품' },
  { id: '7', skuName: 'Resin-Clear', currentStock: 50, safetyStock: 200, status: 'Shortage', turnoverRate: 18.0, warehouse: 'WH-B', category: '원자재' },
];

export const STOCKTAKE_ANOMALY_DATA: StocktakeAnomalyItem[] = [
  { id: '1', materialName: 'Resin-PP-002', location: 'WH-A-01', systemQty: 1000, countedQty: 850, aiExpectedQty: 980, anomalyScore: 95, reason: '실사 오류 의심 (패턴 불일치)', actionStatus: 'none' },
  { id: '2', materialName: 'Display-OLED-1.5', location: 'WH-B-12', systemQty: 500, countedQty: 498, aiExpectedQty: 495, anomalyScore: 10, reason: '정상 범위', actionStatus: 'none' },
  { id: '3', materialName: 'Battery-LiIon-3000', location: 'WH-A-05', systemQty: 200, countedQty: 150, aiExpectedQty: 160, anomalyScore: 88, reason: '도난 또는 누락 가능성', actionStatus: 'none' },
  { id: '4', materialName: 'Cable-USB-C', location: 'WH-C-03', systemQty: 3000, countedQty: 3005, aiExpectedQty: 3000, anomalyScore: 5, reason: '정상 범위', actionStatus: 'none' },
];
...
export const NOTIFICATIONS_DATA: Notification[] = [
    { 
        id: 'n1', type: 'alert', title: '폐기량 급증 경고', 
        message: '3번 라인 Solvent-X 폐기량이 평균 대비 20% 증가했습니다.', 
        time: '10분 전', read: false,
        targetView: 'waste', targetItemId: '2' // Solvent-X id
    },
    { 
        id: 'n2', type: 'alert', title: '재고 부족 알림', 
        message: 'Motor-DC-12V 재고가 안전재고 이하로 떨어졌습니다.', 
        time: '1시간 전', read: false,
        targetView: 'inventory', targetItemId: '1' // Motor-DC id
    },
    { 
        id: 'n3', type: 'info', title: '실사 완료', 
        message: 'WH-A 창고 정기 재고 실사가 완료되었습니다.', 
        time: '3시간 전', read: true,
        targetView: 'stocktake'
    },
    { 
        id: 'n4', type: 'success', title: '수익성 개선', 
        message: 'Premium-Set-A의 마진율이 지난달 대비 5% 상승했습니다.', 
        time: '어제', read: true,
        targetView: 'monthly', targetItemId: 't1' 
    },
];
...
export const MOCK_BOM_HISTORY: BomHistoryItem[] = [
    { id: 'h1', date: '2023-11-07 14:30', skuName: 'Resin-PP-002', actionType: 'Update', description: '표준 소요량 업데이트 (AI 권장)', actor: 'Manager', oldValue: '12.0kg', newValue: '12.8kg' },
    { id: 'h2', date: '2023-11-06 09:15', skuName: 'Solvent-X', actionType: 'Fix', description: '일시적 이상으로 처리 (노즐 정비 완료)', actor: 'Manager' },
    { id: 'h3', date: '2023-11-05 18:00', skuName: 'Bolt-M5-Steel', actionType: 'Update', description: '자동 업데이트 (반복 패턴 감지)', actor: 'AI Agent', oldValue: '5000ea', newValue: '5010ea' },
    { id: 'h4', date: '2023-11-03 10:20', skuName: 'Pkg-Box-S', actionType: 'Ignore', description: '단순 작업자 실수로 인한 폐기 무시', actor: 'Manager' },
];
...
export const MOCK_SUPPLIERS: Supplier[] = [
    { id: 'S1', name: '한화솔루션', method: 'Email', contact: 'order@hanwha.com', managerName: '김철수' },
...
export const MOCK_ORDER_SUGGESTIONS: OrderSuggestion[] = [
    { 
        id: 'O1', skuCode: 'M-DC-12', skuName: 'Motor-DC-12V', supplierId: 'S5', supplierName: '태성산업', method: 'SMS',
        currentStock: 120, safetyStock: 150, avgDailyConsumption: 15, leadTime: 3, 
        suggestedQty: 200, orderQty: 200, unit: 'EA', unitPrice: 15000, status: 'Ready' 
    },
    { 
        id: 'O2', skuCode: 'R-PP-02', skuName: 'Resin-PP-002', supplierId: 'S1', supplierName: '한화솔루션', method: 'Email',
        currentStock: 50, safetyStock: 200, avgDailyConsumption: 25, leadTime: 5, 
        suggestedQty: 500, orderQty: 500, unit: 'KG', unitPrice: 2500, status: 'Ready' 
    },
    { 
        id: 'O3', skuCode: 'SC-M3-10', skuName: 'Screw-M3-10mm', supplierId: 'S3', supplierName: '동국제강', method: 'Fax',
        currentStock: 100, safetyStock: 1000, avgDailyConsumption: 100, leadTime: 2, 
        suggestedQty: 2000, orderQty: 2000, unit: 'EA', unitPrice: 15, status: 'Ready' 
    },
    { 
        id: 'O4', skuCode: 'CH-SOL-B', skuName: 'Chemical Solvent B', supplierId: 'S2', supplierName: 'LG화학', method: 'Kakao',
        currentStock: 80, safetyStock: 100, avgDailyConsumption: 12, leadTime: 4, 
        suggestedQty: 150, orderQty: 150, unit: 'L', unitPrice: 4500, status: 'Ready' 
    },
];