  ...
  return (
    <div className="bg-white dark:bg-surface-dark rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4 mb-6 flex items-start gap-4 transition-colors">
      <div className="p-2 bg-indigo-50 dark:bg-indigo-900/30 rounded-full shrink-0">
        <span className="material-icons-outlined text-indigo-600 dark:text-indigo-400">auto_awesome</span>
      </div>
      <div className="flex-1">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-300 mt-1">
          {insight.description} <span className="text-red-600 dark:text-red-400 font-medium">{insight.highlight}</span> 이는 표준 BOM에서 크게 벗어난 수치이며, 혼합 밸브 보정 문제일 가능성이 있습니다.
        </p>
